...
Why Stellar?
Stellar is ideal for StellarSave because:
...
🔹 Backend
Node.js / Express
Savings logic & automation engine
Fiat-to-USDC integration (on/off-ramp APIs)
🔹 Blockchain Layer
Stellar SDK
USDC asset transactions
...
4. Students
5. Individuals without USD bank access
6. Remote workers earning unstable local currency

Monetization Model

1. 1% withdrawal fee
2. Premium vault features (higher limits, advanced analytics)
3. Partner integrations (remittance platforms, payroll services)
4. Future yield spread model

🛣️ Roadmap
Phase 1 – MVP
-Wallet connection
-USDC deposit & withdrawal
-Manual savings vault
-Transaction history dashboard

Phase 2 – Smart Contracts (Soroban)
-Time-locked vault automation
-Reward logic
...
-Mobile app
-Cross-border remittance savings bridge

Security & Transparency
-Non-custodial wallet integration
-On-chain USDC settlement
-Transparent vault logic via Soroban
-No hidden custody of funds
